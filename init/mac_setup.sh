...
echo "Adding useful aliases to your .aliases..."

echo "alias attach=\"hdiutil attach\"" >> ~/.aliases # attach volume (useful for attaching an encrypted volume)
echo "alias listen=\"lsof -i TCP -n -P | grep LISTEN\"" >> ~/.aliases # show listening ports
...
defaults write NSGlobalDomain AppleHighlightColor -string "0.602802 0.436633 1.000000"
...
# Do not disable disk image verification
...
for app in "Activity Monitor" "Address Book" "Calendar" "Contacts" "cfprefsd" \
  ...
  "Spectacle" "SystemUIServer" "Terminal" "iCal"; do
